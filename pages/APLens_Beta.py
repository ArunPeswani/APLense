        ...
        with st.popover("🔐 Account Login"):
            ...
            with auth_tab_social:
                ...
                try:
                    ...
                    st.link_button("Sign in with Google", google_url, type="secondary", use_container_width=True)
                    st.link_button("Sign in with GitHub", github_url, type="secondary", use_container_width=True)
